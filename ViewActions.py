...
class ViewActions:
    ...
    #---------------------------------------------------------------------------
    # camera
    def update_camera(self, view_dir: int):
        camera = self.GetCamera()

        if view_dir == ViewActions.ViewDir.RightView:  # set x-axis
            # +z up
            # +y right
            # looking forward
        ...
        elif view_dir == ViewActions.ViewDir.LeftView:  # set x-axis
            # +z up
        ...
        elif view_dir == ViewActions.ViewDir.BackView:  # set y-axis
            # +z up
            # +x aft to left
        ...
        elif view_dir == ViewActions.ViewDir.FrontView:  # set y-axis
            # +z up
            # +x aft to right
            # view from left wing
            camera.SetFocalPoint(0., 0., 0.)
        ...
        elif view_dir == ViewActions.ViewDir.TopView:  # set z-axis
            # +x aft
            # +y up (right wing up)
            # top view
            camera.SetFocalPoint(0., 0., 0.)
        ...
        elif view_dir == ViewActions.ViewDir.BottomView:  # set z-axis
            # +x aft
            # -y down (left wing up)
            # bottom view
            camera.SetFocalPoint(0., 0., 0.)
            camera.SetViewUp(0., -1., 0.)
            camera.SetPosition(0., 0., -1.)
        elif view_dir == ViewActions.ViewDir.IsoView:
            camera.SetFocalPoint(0., 0., 0.)
    ...
    #---------------------------------------------------------------------------
    def Render(self):
        self._render.GetRenderWindow().Render()
    ...
    def vtk_interactor(self):
        return self._render.GetRenderWindow().GetInteractor()